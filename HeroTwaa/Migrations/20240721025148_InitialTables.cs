    ...
    public partial class InitialTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillOfQuantities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillOfQuantities_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplianceChecks_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicDashboards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublicDashboards_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoqItems_BillOfQuantities_BoqId",
                        column: x => x.BoqId,
                        principalTable: "BillOfQuantities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_BoqItems_BoqItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillOfQuantities_ProjectId",
                table: "BillOfQuantities",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplianceChecks_ProjectId",
                table: "ComplianceChecks",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Expenses_BoqItemId",
                table: "Expenses",
                column: "BoqItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicDashboards_ProjectId",
                table: "PublicDashboards",
                column: "ProjectId");
